...
const required = ['index.html', 'LICENSE', 'README.md', 'SCIENCE_APPENDIX.md', 'docs/spec.md', 'scripts/smoke.mjs', 'src/main.js', 'src/styles.css', 'src/webmcp.js', 'src/store.js', 'src/logic.js', 'src/data.js'];
